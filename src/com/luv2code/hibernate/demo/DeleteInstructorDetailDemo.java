...
public class DeleteInstructorDetailDemo {
	...
	public static void main(String[] args) {
		...
		try {
			...
			tempInstructorDetail.getInstructor().setIntructorDetail(null);
			
			//delete instructorDetail(this will also delete instructor)
			//because of bi directional mapping and CascadeType.All
